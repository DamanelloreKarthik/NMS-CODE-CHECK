...
# RFC 5424 / RFC 3164 compliant parsing logic
# This implementation follows standard syslog parsing practices
# with project-specific adaptations where required
...
def parse_syslog(raw: str, source_ip: str):
    ...
    event_type = detect_security_events(message)
    if event_type:
...
def detect_security_events(message: str):
