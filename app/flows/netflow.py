...
from app.core.redis_client import save_v9_template, get_v9_template
...
def parse_v9_template(data, exporter_ip):
    ...
    while offset + 4 <= len(data):
        ...
        # REDIS STORE
        save_v9_template(exporter_ip, template_id, fields)
...
def parse_v9_data(template_id, data, exporter_ip):
    # REDIS FETCH
    fields = get_v9_template(exporter_ip, template_id)
